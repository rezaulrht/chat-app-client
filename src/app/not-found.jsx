            ...
            <div className="relative z-10 w-full max-w-md text-center space-y-8">
                ...
                <div className="space-y-3">
                    ...
                    <p className="text-ivory/50 text-sm md:text-base leading-relaxed">
                        The space you're looking for has vanished into the void. Either it never existed, or it's taken a trip to another dimension.
                    </p>
                </div>
                ...
                <div className="flex gap-3 justify-center flex-wrap pt-4">
                    <button
                        onClick={() => router.back()}
                        className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-white/[0.04] border border-white/[0.08] text-ivory text-sm font-mono hover:bg-white/[0.08] hover:border-white/[0.12] transition-all duration-200"
                    >
                        <ArrowLeft size={14} />
                        Go Back
                    </button>
