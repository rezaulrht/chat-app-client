    ...
    <div>
      ...
      <div className="bg-obsidian text-ivory overflow-hidden">
        ...
        <section className="relative py-32 px-6 flex flex-col items-center text-center">
          ...
          />
          <div
            className="absolute -top-24 -left-24 w-96 h-96 rounded-full blur-[120px] -z-0"
          ...
          <div className="relative z-10 max-w-4xl">
            ...
            <h1 className="font-display text-3xl sm:text-5xl md:text-7xl font-bold tracking-[-0.02em] mb-8 leading-[1.1] text-ivory">
            ...
            <p className="text-ivory/40 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed font-light">
          ...
          <div className="relative max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {values.map((value, index) => (
                <div
                  key={index}
                  className="relative rounded-3xl border border-white/[0.05] p-8 group overflow-hidden transition-all duration-500 hover:border-white/[0.1]"
