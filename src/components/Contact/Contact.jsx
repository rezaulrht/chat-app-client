      ...
      <div className="bg-obsidian text-ivory py-24 px-6 relative overflow-hidden min-h-screen">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="text-center mb-16">
            <h1 className="font-display text-3xl sm:text-5xl md:text-6xl font-bold mb-6 tracking-[-0.02em] text-ivory">
              Get in{" "}
              <span className="font-serif italic text-accent">touch</span>
            </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            >
              <form className="space-y-6">
                ...
                <div className="relative">
                  ...
                  <div className="absolute right-5 top-1/2 -translate-y-1/2 pointer-events-none text-ivory/30 text-xs">
                    &#9660;
                  </div>
                </div>
            ...
            <div className="lg:col-span-5 space-y-8">
              {/* Contact Info */}
              <div
                className="border border-white/[0.06] p-8 rounded-[2rem]"
                style={{ background: DEEP }}
              >
                <h3 className="font-display text-xl font-bold mb-8 text-ivory">
                  Contact Information
                </h3>
                <div className="space-y-8">
                  <div className="flex gap-4">
                    ...
                    <div>
                      <p className="text-xs text-ivory/30 uppercase tracking-widest font-bold mb-1 font-mono">
                        Email Us
                      </p>
                ...
                <div className="mt-12 pt-8 border-t border-white/[0.04]">
                  <p className="text-[10px] text-ivory/20 uppercase tracking-[0.3em] font-bold mb-6 font-mono">
                    Follow Updates
                  </p>
