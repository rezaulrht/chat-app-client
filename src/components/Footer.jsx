      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
        <aside className="col-span-1 md:col-span-2 space-y-6">
          ...
          <div className="flex gap-4">
            <a
              href="#"
              className="w-10 h-10 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center hover:bg-[#13c8ec]/10 hover:border-[#13c8ec]/30 hover:text-[#13c8ec] transition-all"
            >
        ...
        <nav className="space-y-4">
          ...
          <ul className="space-y-3 text-sm font-light">
            <li>
              <a href="#" className="hover:text-[#13c8ec] transition-colors">
                Features
              </a>
            </li>
            <li>
